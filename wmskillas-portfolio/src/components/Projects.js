        ...
        <div className="card cardSize m-3">
          ...
          <div className="card-body headerBg textColor">
            ...
            <p className="card-text border-bottom border-dark">
              Developed an environment where professional's could go to post and
              share their work. This is a Front End App using HTML, CSS,
        ...
        <div className="card cardSize m-3">
          ...
          <div className="card-body headerBg textColor">
            ...
            <p className="card-text border-bottom border-dark">
              ...
              them. They can also make comments on them as well. Authentication
              was set up where users need to create a username and password as
              well as submit an email address.
            </p>
            <div className="text-center">
              <a
